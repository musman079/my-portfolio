<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=1,14,23&height=260&section=header&text=Muhammad%20Usman&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=36&desc=Ultra-Modern%20Full-Stack%20Developer%20Portfolio%20•%20Next.js%2015%20•%20React%2019%20•%20MongoDB%20CMS&descFontSize=19&descAlignY=58&descAlign=50" alt="Muhammad Usman Portfolio Banner" width="100%" />

  <!-- Animated Typing SVG Subtitle -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&duration=3000&pause=1000&color=F59E0B&center=true&vCenter=true&width=620&lines=⚡+Full-Stack+MERN+&+Next.js+15+Architect;🚀+Fiverr+Level-1+Top+Rated+Freelancer+(★5.0);🎮+Interactive+CLI+Terminal+&+Web+Audio+Synth;🌌+120+FPS+Hardware-Accelerated+Physics+Canvas;🔒+Dynamic+MongoDB+Atlas+CMS+Admin+Panel" alt="Typing SVG Animation" />
  </a>
  ...
  <p align="center">
    <a href="https://nextjs.org/"><img src="https://img.shields.io/badge/Next.js_15.2-000000?style=for-the-badge&logo=nextdotjs&logoColor=white" alt="Next.js 15" /></a>
    <a href="https://react.dev/"><img src="https://img.shields.io/badge/React_19-20232A?style=for-the-badge&logo=react&logoColor=61DAFB" alt="React 19" /></a>
    <a href="https://www.typescriptlang.org/"><img src="https://img.shields.io/badge/TypeScript_5.x-007ACC?style=for-the-badge&logo=typescript&logoColor=white" alt="TypeScript 5" /></a>
    ...
    <a href="https://www.mongodb.com/"><img src="https://img.shields.io/badge/MongoDB_Atlas-4EA94B?style=for-the-badge&logo=mongodb&logoColor=white" alt="MongoDB" /></a>
    <a href="https://mongoosejs.com/"><img src="https://img.shields.io/badge/Mongoose_ODM-880000?style=for-the-badge&logo=mongoose&logoColor=white" alt="Mongoose" /></a>
  </p>

  <!-- Badges Row 2: Status & Ratings -->
  <p align="center">
    <a href="https://www.fiverr.com/musman079"><img src="https://img.shields.io/badge/Fiverr-Level%201%20Seller%20★5.0-1dbf73?style=for-the-badge&logo=fiverr&logoColor=white" alt="Fiverr Status" /></a>
    <img src="https://img.shields.io/badge/Performance-120_FPS_Canvas-ff5722?style=for-the-badge&logo=speedtest&logoColor=white" alt="120 FPS" />
    <img src="https://img.shields.io/badge/Audio-Web_Audio_API-9c27b0?style=for-the-badge&logo=audio-technica&logoColor=white" alt="Web Audio API" />
...
```mermaid
flowchart TD
    subgraph Client["🖥️ Client Browser (Next.js 15 App Router)"]
        UI["Main Portfolio Page (app/page.tsx)"]
        CLI["Interactive CLI Terminal (components/dev-terminal.tsx)"]
        PAL["Command Palette (Ctrl+K)"]
        EST["Cost Estimator (components/cost-estimator.tsx)"]
        MOD["Project Detail Modal (components/project-modal.tsx)"]
        CANVAS["120 FPS Constellation Canvas (HTML5 2D)"]
        AUDIO["Web Audio API Synthesizer (lib/sound-effects.ts)"]
        ADMIN["Admin CMS Dashboard (app/admin/page.tsx)"]
    end

    subgraph API["⚡ Serverless REST API Handlers (app/api/)"]
        API_PROF["/api/profile (GET, POST)"]
        API_PROJ["/api/projects (GET, POST, PUT, DELETE)"]
        API_SKIL["/api/skills (GET, POST, PUT, DELETE)"]
        API_SERV["/api/services (GET, POST, PUT, DELETE)"]
        API_REV["/api/reviews (GET, POST, PUT, DELETE)"]
        API_CONT["/api/contact (POST)"]
    end

    subgraph Storage["🗄️ Database & Config Layer"]
        MONGO[("MongoDB Atlas Database")]
        MODELS["Mongoose Schemas (models/)"]
        FALLBACK["Static Site Config (lib/site-config.ts)"]
    end

    UI -->|1. Fetch Initial Content| API
    ADMIN -->|Manage Content CRUD| API
    API -->|Mongoose Cache Handler| MONGO
    API -.->|Database Offline Fallback| FALLBACK
    UI --> CANVAS
    UI --> AUDIO
    CLI --> UI
    PAL --> UI
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=1,14,23&height=120&section=header&text=Muhammad%20Usman&fontSize=32&fontColor=ffffff&desc=Dedicated%20Full-Stack%20MERN%20Engineer%20•%20Faisalabad,%20Pakistan&descFontSize=15" width="100%" />
</div>
...
<div align="center">
  ...
  &nbsp;
  <a href="https://wa.me/923189053287">
  ...
  <a href="https://github.com/musman079">
    <img src="https://img.shields.io/badge/GitHub-musman079-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" />
  </a>
